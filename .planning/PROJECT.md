...
- [ ] Eval suite with A-F grading, LLM-as-judge, certification tiers
...
| Build on OSS eval patterns (MIT-0) | Battle-tested eval patterns with 621 tests; extend don't rebuild | -- Pending |
